  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="relative flex flex-col h-screen bg-[#FFF7EC] px-16 py-4 justify-center items-center gap-4">
        ...
        <div className="h-11/12 w-11/12 bg-white"></div>
      </div>
      {/* Who We Are */}
      <div className="relative flex flex-col h-screen bg-[#FFF7EC] px-16 py-4 justify-center items-center gap-4">
        <div className="text-black text-5xl font-bold text-end w-full">เราคือทีม <span className="text-[#95E999]">HR Co-Pilot</span><br />ที่เข้าใจ SME และ Startup อย่างแท้จริง</div>
        <div className="text-gray-500 text-4xl text-end w-full">“คุณโฟกัสที่การเติบโตของธุรกิจ ส่วนเราดูแลเรื่อง <span className="font-bold">คน</span> ให้ทั้งหมด” เราไม่ได้แค่จัดหาพนักงาน แต่เราช่วยวางระบบ HR ที่ยั่งยืนตั้งแต่วันแรก</div>
      ...
      {/* Insights */}
      <div className="relative flex flex-col h-screen bg-[#2D2D2D] px-10 py-16 justify-center items-center gap-4" id="insights">
        <div className="text-6xl font-bold w-full">เพราะเราไม่ใช่แค่จัดหาคน<br />แต่เราสร้าง <span className="text-[#95E999]">ทุนมนุษย์</span> ให้คุณ</div>
        <div className="text-[24px] text-gray-400 w-full">จาก “People” สู่ “Performance” เราคือพาร์ตเนอร์ HR ที่ช่วยให้ธุรกิจของคุณเติบโตได้อย่างยั่งยืน<br />ด้วยระบบการบริหารคนที่ครบวงจร เข้าใจ SME และคุ้มค่าที่สุดในตลาด</div>
        <div className="h-11/12 w-11/12 bg-white"></div>
      </div>
      {/* Testimonials */}
      <div className="relative flex flex-col h-screen bg-[#2D2D2D] px-10 py-16 justify-center items-center gap-4" id="testimonials">
        <div className="text-6xl font-bold w-full">ลูกค้าจริงที่ไว้วางใจเรา</div>
        <div className="text-4xl text-gray-400 w-full">“เราทำงานในฐานะ HR Co-Pilot ให้ SME/Startup<br />ตั้งแต่สรรหา วางระบบ จนถึงประเมินผล เพื่อให้ธุรกิจโฟกัสการเติบโตได้เต็มที่”</div>
        <div className="h-11/12 w-11/12 bg-white"></div>
      </div>
      {/* About Us */}
