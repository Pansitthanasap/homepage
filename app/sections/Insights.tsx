...
const InsightCard: React.FC<InsightCardProps> = ({
  ...
  return (
    <div className={`relative p-8 rounded-[30px] transition-all duration-500 ease-in-out cursor-pointer 
    ${isActive ? "bg-[#95E999]" : "bg-[#FFF7EC]"} 
    shadow-lg`} onClick={onClick}>
      <div
...
export default function Insights() {
  ...
  return (
    <div
      className="flex flex-col h-screen px-10 py-16 justify-center items-center gap-4 bg-[#2D2D2D]"
      id="insights"
    >
      ...
      <div className="text-[24px] text-gray-400 w-full">
        จาก “People” สู่ “Performance” เราคือพาร์ตเนอร์ HR ที่ช่วยให้ธุรกิจของคุณเติบโตได้อย่างยั่งยืน <br />
        ด้วยระบบการบริหารคนที่ครบวงจร เข้าใจ SME และคุ้มค่าที่สุดในตลาด
      </div>
      <div className="flex flex-col w-full gap-6 overflow-y-auto">
